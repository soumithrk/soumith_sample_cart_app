...
public class EnvironmentConfig {
   ...
   public InstrumentedAppender loggerInstrumentedAppender() {
      ...
      Logger rootLogger = factory.getLogger(Logger.ROOT_LOGGER_NAME);
   ...
   public StatsDReporter statsdReporter() {
      ...
      StatsDReporter statsdReporter = StatsDReporter.forRegistry(metricRegistry()).prefixedWith(statsdMetricPrefix)
