...
public class BaseController {
    ...
    */
   private static final ClassValueLookupMap<Exception, HttpStatus> EXCEPTION_MAP = new ClassValueLookupMap<>(
   ...
   private static final LoadingCache<Class<? extends Exception>, HttpStatus> EXCEPTION_MAP_CACHE = CacheBuilder
         .newBuilder().maximumSize(EXCEPTION_CACHE_SIZE)
      ...
      if (e instanceof MethodArgumentNotValidException) {
         ...
         for (ObjectError error : me.getBindingResult().getAllErrors()) {
            ...
            if (!StringUtils.isEmpty(error.getObjectName()) && error.getCodes() != null
               ...
               Optional<String> matchingCode = Arrays.stream(error.getCodes())
